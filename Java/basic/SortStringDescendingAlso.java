 ...
 */
public class SortStringDescendingAlso 
{
    ...
    public static void main( String[] args ) 
	{
		...
		try																							//this try block is to catch the inevitable exception caused by the user quitting 
		{
			...
			{            
                ...
                String output = new StringBuffer( new String( arr ) ).reverse().toString();         //Create a string from the sorted char array in reverse                
