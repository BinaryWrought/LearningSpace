 ...
 * A[5] = 4 -> B[4] = 5
 * 
 * While solving this challenge I decided to see if there was an easier way to print the array besides a loop.
 * I found a nice lambda equation that could do it. The problem is there doesn't appear to be a way to add spaces between values.
 * This solution uses a string array as a work-around. Its just a fun exercise that actually complicates the solution.
 * 
 * @author <a href="mailto:jhazelle@asu.edu">Justin Hazelle</a>
 * <a href="https://github.com/BinaryWrought" target="_blank">GitHub</a>
 */
public class InversePermutationToo 
{
    ...
    public static void main( String[] args ) 
	{
		...
		try																							//this try block is to catch the inevitable exception caused by the user quitting 
		{
			...
			{		
                ...
                String[] b = new String[ n ];                                                       //container for the inverse permutation array
                ...
                Arrays.stream( b ).forEach( System.out::print );                                    //A lambda expression to print the elements of the array
                
                //If you want to print the array with brackets and commas use this  
